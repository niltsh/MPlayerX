...
extern NSString * const kUDKeySeekStepL;
extern NSString * const kUDKeySeekStepR;
extern NSString * const kUDKeySeekStepU;
extern NSString * const kUDKeySeekStepB;
...
extern NSString * const kUDKeyCacheSizeLocalMinLimit;
extern NSString * const kUDKeyCacheSizeLocalTime;
